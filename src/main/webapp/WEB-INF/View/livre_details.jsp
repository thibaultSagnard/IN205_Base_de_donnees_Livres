...
<body>
  ...
  <main>
    <section class="content">
      ...
      <div class="row">
      <div class="container">
      <h5>Details du livre numero ${livre.getIdPrimaryKey()}</h5>
        <div class="row">
	      <form action="/TP3Ensta/livre_details?id=${livre.getIdPrimaryKey()}" method="post" class="col s12"> <!-- TODO : remplacer idDuLivre par l'id du livre -->
	        <div class="row">
